...
class ModelTests: XCTestCase {
    ...
    func testMainScrViewModelExample() {
      let jsonString = """
                          {
                          "title":"About Canada",
                          "rows":[
      ...
      let row1 = Row(title: "Beavers",
                     description: "Beavers are second only to humans in their ability to manipulate and change their environment. They can measure up to 1.3 metres long. A group of beavers is called a colony",
                     imageHref: "http://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/American_Beaver.jpg/220px-American_Beaver.jpg"
      )
      
      let row2 = Row(title: "Flag",
                     description: nil,
                     imageHref: "http://images.findicons.com/files/icons/662/world_flag/128/flag_of_canada.png"
      )
      
      let viewModel1 = try? JSONDecoder().decode(MainScreenViewModel.self, from: json)
      let viewModel2 = MainScreenViewModel(title: "About Canada", rows: [row1, row2])
